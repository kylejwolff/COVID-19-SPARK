...
object Driver {
  ...
  def main(args: Array[String]): Unit = {
    ...
    while(run) {
      ...
      println("+ 7 - Query 7: US Confirmed Cases Per Capita by quarter                         +")
      println("+ 8 - Query 8: US Confirmed Cases, Deaths, and Recovered Per Capita by quarter  +")
      println("+ 9 - Query 9: Global Confirmed Cases Per Capita by quarter                     +")
